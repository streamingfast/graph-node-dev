...
export function handleSwap(event: Swap): void {
  ...
  let derivedAmountBNB = token1!
    .derivedBNB!.times(amount1Total)
  ...
  let swap = new SwapEvent(
    event.transaction.hash.toHex().concat("-").concat(BigInt.fromI32(swaps.length).toString())
  )
