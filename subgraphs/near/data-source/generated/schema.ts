...
export class CreatedContract extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save CreatedContract entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save CreatedContract entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("CreatedContract", id.toString(), this);
    }
  }

  static load(id: string): CreatedContract | null {
    return changetype<CreatedContract | null>(store.get("CreatedContract", id));
  }
